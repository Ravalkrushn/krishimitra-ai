...
const COPY = {
  en: {
    nav: {
      ...
      priceFairness: "Price Fairness Checker",
  ...
  hi: {
    nav: {
      ...
      priceFairness: "मूल्य तुलना जांच",
  ...
  gu: {
    nav: {
      home: "હોમ",
      market: "બજાર માહિતી",
      marketComparison: "બજાર સરખામણી",
      sellingHistory: "વેચાણ ઇતિહાસ",
      buyers: "ખરીદદાર શોધો",
      ...
      priceFairness: "ભાવ સરખામણી તપાસ",
