...
import {
  GiFarmer, GiWheat, GiCottonFlower,
} from "react-icons/gi";
...
export default function LoginPage() {
  ...
  return (
    <div style={{
      minHeight: "100vh",
      background: "linear-gradient(135deg, #0d3b1f 0%, #1a5c2a 40%, #2e7d32 100%)",
      display: "flex",
      alignItems: "center",
      ...
      <div style={{ position:"absolute", top:"30%", left:"5%", opacity:0.06, fontSize:120 }}><GiWheat /></div>
      <div style={{ position:"absolute", bottom:"15%", right:"8%", opacity:0.06, fontSize:100 }}><GiCottonFlower /></div>
      ...
      <div style={{ width:"100%", maxWidth:440, position:"relative", zIndex:10 }}>
        ...
        <div style={{ textAlign:"center", marginBottom:32 }}>
          ...
          <p style={{ color:"rgba(255,255,255,0.7)", fontSize:14, marginTop:6 }}>
            From Farm to Best Market Decision
          </p>
        </div>
        ...
        <div style={{
          ...
          <p style={{ fontSize:13, color:"#6b7280", margin:"0 0 24px" }}>
            Access your KrishiMitra AI dashboard
          </p>
          ...
          <form onSubmit={submit}>
            ...
            <button
              ...
              style={{
                ...
                background: loading ? "#9ca3af" : "linear-gradient(135deg, #1a5c2a, #2e7d32)",
          ...
          <div style={{ marginTop:20, paddingTop:20, borderTop:"1px solid #f3f4f6" }}>
            ...
            <div style={{ display:"flex", gap:8 }}>
              <button
                ...
                style={{
                  flex:1, padding:"9px", background:"#f0faf0", border:"1.5px solid #a5d6a7",
                  borderRadius:8, fontSize:12, fontWeight:700, color:"#1a5c2a", cursor:"pointer",
              ...
              <button
                ...
                style={{
                  flex:1, padding:"9px", background:"#eff6ff", border:"1.5px solid #bfdbfe",
            ...
            <div style={{ marginTop:12, padding:"10px 12px", background:"#fffbeb", border:"1px solid #fde68a", borderRadius:8 }}>
              <p style={{ fontSize:11, color:"#92400e", margin:0, lineHeight:1.6 }}>
                <strong>Demo:</strong> farmer / krishimitra123 &nbsp;|&nbsp; admin / admin123
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginTop:16 }}>
          {[
            ...
            <div key={i} style={{
              background:"rgba(255,255,255,0.1)", borderRadius:10, padding:"10px 8px",
              textAlign:"center", color:"rgba(255,255,255,0.85)", fontSize:11, fontWeight:600,
            }}>
        ...
        <p style={{ textAlign:"center", color:"rgba(255,255,255,0.5)", fontSize:11, marginTop:16 }}>
